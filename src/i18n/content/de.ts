...
export const de: SiteContent = {
  ...
  home: {
    ...
    hero: {
      ...
      compare: {
        basket: 'Dein Warenkorb · 14 Artikel',
        caption: 'Verglichen in jedem Geschäft, in dem du es kaufen kannst.',
        cheapest: 'Am günstigsten',
        save: 'Du sparst <b>4,20 €</b> bei diesem Einkauf',
        shops: [
    ...
    couponsSec: {
      ...
      cards: [
        ...
        {
          h: 'Gib einen ab, frag einen an, den du brauchst',
          p: 'Einen Gutschein, den du vor Ablauf nicht nutzt? Gib ihn ab und verdiene Karma — auch ein gescannter Kassenbon oder ein hinzugefügter Preis bringt Karma ein. Selbst einen Gutschein gebraucht? Wähle den Laden unter <strong>Anfragen</strong>, und Tallywise gibt dir den, der als Nächstes abläuft.',
        },
      ],
    },
    shots: {
  ...
  coupons: {
    ...
    how: {
      ...
      cards: [
        ...
        {
          h: '3. Gib ihn ab, oder frag einen an',
          p: 'Einen, den du sicher nicht nutzt? Tippe auf das Geschenk-Symbol, um ihn abzugeben — das bringt dir Karma ein, und er landet im geteilten Pool. Selbst einen gebraucht? Öffne <strong>Anfragen</strong>, wähle den Laden und die Gutscheinart, und Tallywise gibt dir den, der als Nächstes abläuft.',
        },
      ],
    },
    fair: {
      h2: 'Karma hält das Teilen fair.',
      ps: [
        'Jeder Gutschein im Pool stammt aus dem Karma von jemand anderem. Gib einen ab, scanne einen Kassenbon oder füge einen Preis hinzu, und du verdienst welches — je weiter ein Gutschein von seinem Ablaufdatum entfernt ist, desto mehr Karma bringt er ein. Gib etwas davon aus, um einen anzufragen: Wähle einen Laden und eine Gutscheinart, und Tallywise gibt dir den, der als Nächstes abläuft. Ist dein Karma aufgebraucht, pausiert das Anfragen, bis du wieder aufgefüllt hast.',
        'Dein Karma-Saldo ist privat — niemand sonst sieht ihn — und wir verknüpfen nie deinen Namen oder deine E-Mail mit einem Gutschein, den du abgibst; nur die eigenen Angaben des Gutscheins (Wert, Bedingungen, Daten, Barcode) reisen mit.',
      ],
    },
    faq: {
      h2: 'Häufige Fragen.',
      items: [
        ...
        { q: 'Funktioniert ein Gutschein, den mir jemand gegeben hat, an der Kasse?', a: 'Meistens ja — aber Gutscheine werden vom Händler ausgegeben, nicht von Tallywise. Sie sind in der Regel einmalig und zeitlich begrenzt. Wir können nicht überprüfen, ob ein geteilter Gutschein nicht bereits eingelöst wurde; wurde ein Gutschein verwendet oder abgelehnt, frag stattdessen einen anderen an.' },
        { q: 'Was ist Karma?', a: 'Karma ist Tallywises Fair-Use-Punktestand für den Gutschein-Pool — einfach Punkte, keine Währung. Du verdienst es, indem du einen Gutschein abgibst, einen Kassenbon scannst oder einen Preis hinzufügst, und gibst jedes Mal etwas davon aus, wenn du einen Gutschein aus dem Pool anfragst. Nur du siehst deinen eigenen Saldo.' },
  ...
  privacy: {
    ...
    heroSub: 'Zuletzt aktualisiert am 21. August 2026. Tallywise wird von MonkeyLittle betrieben. Fragen: <a href="mailto:%EMAIL%">%EMAIL%</a>.',
    blocks: [
      ...
      { h: 'Gutscheine teilen', ps: ['Wenn du dich entscheidest, einen Gutschein abzugeben, werden seine Angaben (Wert, Bedingungen, Gültigkeitsdaten, der Laden und der Barcode/die Nummer zum Einlösen) einem geteilten Pool hinzugefügt, den andere Tallywise-Nutzer nach Laden und Gutscheinart anfragen können. Das ist etwas, wofür du dich <strong>pro Gutschein entscheidest</strong> — Gutscheine, die du nur speicherst, bleiben privat in deinem Konto. Wir teilen deine Identität nicht neben einem gepoolten Gutschein. Einen Gutschein abzugeben oder anzufragen bringt <strong>Karma</strong> ein oder kostet es — unseren Fair-Use-Punktestand für den Pool. Ein Gutschein, den du abgibst, verlässt deine Brieftasche und kann von jemand anderem angefragt werden; du kannst ihn zurücknehmen, solange er im Pool ist.'] },
    ...
    blocks: [
      ...
      { h: '13. Aussetzung &amp; Beendigung', ps: ['Du kannst die Nutzung von Tallywise jederzeit einstellen und dein Konto in den Einstellungen der App oder per E-Mail an uns löschen. Wir können deinen Zugang aussetzen oder beenden, wenn du gegen diese Bedingungen verstößt oder wo es vernünftigerweise nötig ist, um den Dienst oder andere Nutzer zu schützen. Bei der Löschung werden deine Kontodaten wie in unserer <a href="%PRIVACY%">Datenschutzerklärung</a> beschrieben entfernt; anonymisierte Preisdaten können aufbewahrt werden.'] },
      {
        ...
        ps: [
          ...
          'Zwischen Nutzern geteilte Gutscheine werden <strong>„wie besehen“ und auf eigenes Risiko</strong> bereitgestellt. Ein Gutschein, den du anfragst, kann bereits verwendet worden sein, abgelaufen sein oder an der Kasse abgelehnt werden, und wir <strong>können nicht überprüfen oder garantieren, dass ein Gutschein gültig, unbenutzt oder akzeptiert wird</strong>. Soweit gesetzlich zulässig, haftet MonkeyLittle nicht für einen Gutschein, der nicht funktioniert, für einen von einem anderen Nutzer geteilten Gutschein oder für einen Streit zwischen Nutzern über einen geteilten Gutschein.',
          'Das Teilen läuft über <strong>Karma</strong>, Tallywises Fair-Use-Punktestand für den Pool: Einen Gutschein abzugeben, einen Kassenbon zu scannen oder einen Preis hinzuzufügen bringt Karma ein, und einen Gutschein anzufragen kostet es — so kann der Pool nicht von einer Handvoll Konten leergeräumt werden. Wir können festlegen, ändern oder durchsetzen, wie Karma verdient oder ausgegeben wird, sowie Gutscheine entfernen oder Konten einschränken, um Missbrauch des Pools zu verhindern.',
        ],
      },
      {
